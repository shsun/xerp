...
public class BaseCommonUtil {
	...
	/**
	 * 
	 * @Title: beanToMap @param obj @return @return
	 * Map<String,Object> @Description: 这种反射方式可以将与model中处了get方法以外的所有方法排除，
	 * 静态变量也排除在外 @throws
	 */
		...
		try {
			for (int i = 0; i < methods.length; i++) {
				...
				if (methodName.contains("get")) {
					...
					if (method.invoke(obj, "") != null && !"".equals(method.invoke(obj, ""))) {
