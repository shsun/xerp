...
public class BaseDateUtil {
	public static final String DATE_FORMAT_MINUTE = "yyyy-MM-dd HH:mm";//默认日期格式
    ...
    public static String getFormatStringSecond(Date date) {
        return getFormatString(date, DATE_FORMAT_MINUTE);
    }
    ...
    public static void main(String[] args) {
    	String t = getFormatStringSecond(new Date());
