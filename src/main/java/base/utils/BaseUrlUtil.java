...
//    }
    public static String download(String urlStr, String charsetName) {
        ...
        try {
            ...
            log.error("我捕获到了 UnknownHostException 异常：" +urlStr);
            //e.printStackTrace();
            return BaseConstant.UnknownHostException;
        } catch (Exception e) {
    ...
    public static void write(String url, String filePath, Date updateDate, boolean override) {
        ...
        if (BaseStringUtil.isBlank(html) || html.length()<100) {
            log.warn("抓取" +url + " 内容长度<100");
            return;
        }
        try {
